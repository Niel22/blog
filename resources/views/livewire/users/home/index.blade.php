                                        ...
                                        <div class="jl_grid_box_wrapper">
                                            <div class="image-post-thumb">
                                                <a href="#" class="link_image featured-thumbnail"
                                                    ...
                                                    <img width="780" height="450"
                                                        src="{{ asset('assets_front/img/uploads/2019/02/daniel-korpai-1236913-unsplash-780x450.jpg') }}"
                                            ...
                                            <div class="post-entry-content">
                                                ...
                                                <span class="jl_post_meta"><span class="jl_author_img_w"> <img
                                                            src="{{asset('assets_front/img/favicon.jpg')}}" width="30" height="30"
                                                            alt="Anna Nikova"
                                        ...
                                        <div class="jl_grid_box_wrapper">
                                            <div class="image-post-thumb">
                                                <a href="#" class="link_image featured-thumbnail"
                                                    ...
                                                    <img width="780" height="450"
                                                        src="{{ asset('assets_front/img/uploads/2019/02/s-o-c-i-a-l-c-u-t-1133933-unsplash-780x450.jpg') }}"
                                                        class="attachment-disto_large_feature_image size-disto_large_feature_image wp-post-image"
                                                        alt="" />
                                                    <div class="background_over_image"></div>
                                                </a> <span class="meta-category-small"><a
                                        ...
                                        <div class="jl_grid_box_wrapper">
                                            <div class="image-post-thumb">
                                                <a href="#" class="link_image featured-thumbnail"
                                                    ...
                                                    <img width="780" height="450"
                                                        src="{{ asset('assets_front/img/uploads/2019/02/wade-lambert-681672-unsplash-780x450.jpg') }}"
                                                        class="attachment-disto_large_feature_image size-disto_large_feature_image wp-post-image"
                                                        alt="" />
                                                    <div class="background_over_image"></div>
                                                </a> <span class="meta-category-small"><a
                                        ...
                                        <div class="jl_grid_box_wrapper">
                                            <div class="image-post-thumb">
                                                <a href="#" class="link_image featured-thumbnail"
                                                    ...
                                                    <img width="780" height="450"
                                                        src="{{ asset('assets_front/img/uploads/2019/02/roberto-nickson-1299738-unsplash-780x450.jpg') }}"
                                                        class="attachment-disto_large_feature_image size-disto_large_feature_image wp-post-image"
                                                        alt="" />
                                                    <div class="background_over_image"></div>
                                                </a> <span class="meta-category-small"><a
                                        ...
                                        <div class="jl_grid_box_wrapper">
                                            <div class="image-post-thumb">
                                                <a href="#" class="link_image featured-thumbnail"
                                                    ...
                                                    <img width="780" height="450"
                                                        src="{{ asset('assets_front/img/uploads/2019/02/lucas-benjamin-1326601-unsplash-780x450.jpg') }}"
                                                        class="attachment-disto_large_feature_image size-disto_large_feature_image wp-post-image"
                                                        alt="" />
                                                    <div class="background_over_image"></div>
                                                </a> <span class="meta-category-small"><a
                                                        class="post-category-color-text" style="background:#ed1c1c"
                                                        href="#">Active</a></span> <span class="jl_post_type_icon"><i
                                        ...
                                        <div class="jl_grid_box_wrapper">
                                            <div class="image-post-thumb">
                                                <a href="#" class="link_image featured-thumbnail"
                                                    ...
                                                    <img width="780" height="450"
                                                        src="{{ asset('assets_front/img/uploads/2018/11/mikky-koopac-1056364-unsplash-780x450.jpg') }}"
                                                        class="attachment-disto_large_feature_image size-disto_large_feature_image wp-post-image"
                                                        alt="" />
                                                    <div class="background_over_image"></div>
                                                </a> <span class="meta-category-small"><a
                    ...
                    <div class="jl_3col_wrapin">
                        ...
                        <div
                            ...
                            <div class="jl_wrapper_row jl-post-block-314983">
                                <div class="row">
                                    <div class="col-md-4 blog_grid_post_style jl_row_1">
                                        <div class="jl_grid_box_wrapper"> <span class="image_grid_header_absolute"
                                                style="background-image: url('{{ asset('assets_front/img/uploads/2019/02/michal-wichrzynski-70497-unsplash-780x450.jpg') }}')"></span>
                                            <a href="#" class="link_grid_header_absolute"
                                    ...
                                    <div class="col-md-4 blog_grid_post_style jl_row_2">
                                        <div class="jl_grid_box_wrapper"> <span class="image_grid_header_absolute"
                                                style="background-image: url('{{ asset('assets_front/img/uploads/2018/11/rawpixel-603012-unsplash-780x450.jpg') }}')"></span>
                                            <a href="#" class="link_grid_header_absolute"
                                    ...
                                    <div class="col-md-4 blog_grid_post_style jl_row_3">
                                        <div class="jl_grid_box_wrapper"> <span class="image_grid_header_absolute"
                                                style="background-image: url('{{ asset('assets_front/img/uploads/2018/11/taylor-grote-516831-unsplash-780x450.jpg') }}')"></span>
                                            <a href="#" class="link_grid_header_absolute"
                                                title="Nice Photo, nice colors and i can&#8217;t wait to try"></a> <span
                                                class="meta-category-small"><a class="post-category-color-text"
                                                    style="background:#ed1c1c" href="#">Active</a></span>
                                            <div class="post-entry-content">
                                                <h3 class="image-post-title"><a href="#">
                ...
                <div class="col-md-8" id="content">
                    <div
                        ...
                        <div class="blog_list_post_style">
                            <div class="image-post-thumb featured-thumbnail home_page_builder_thumbnial">
                                <div class="jl_img_container"> <span class="image_grid_header_absolute"
                                        style="background-image: url('{{ asset('assets_front/img/uploads/2018/11/pexels-photo-1036628-780x450.jpg') }}')"></span>
                                    <a href="#" class="link_grid_header_absolute"></a>
                                </div>
                            </div>
                            <div class="post-entry-content"> <span class="meta-category-small"><a
                                        class="post-category-color-text" style="background:#ed1c1c"
                                        href="#">Active</a></span> <span
                                    class="post-meta meta-main-img auto_image_with_date"><span class="post-date"><i
                                            class="fa fa-clock-o"></i>Dec 24, 2016</span><span class="meta-comment"><a
                        ...
                        <div class="blog_list_post_style">
                            <div class="image-post-thumb featured-thumbnail home_page_builder_thumbnial">
                                <div class="jl_img_container"> <span class="image_grid_header_absolute"
                                        style="background-image: url('{{ asset('assets_front/img/uploads/2019/02/michael-browning-246513-unsplash-780x450.jpg') }}')"></span>
                                    <a href="#" class="link_grid_header_absolute"></a>
                                </div>
                            </div>
                            <div class="post-entry-content"> <span class="meta-category-small"><a
                                        class="post-category-color-text" style="background:#d66300"
                                        href="#">Science</a></span> <span
                                    class="post-meta meta-main-img auto_image_with_date"><span class="post-date"><i
                                            class="fa fa-clock-o"></i>Dec 24, 2016</span><span class="meta-comment"><a
                                            href="#"><i class="fa fa-comment"></i>0</a></span></span>
                                <h3 class="image-post-title"><a href="#">
                        ...
                        <div class="blog_list_post_style">
                            <div class="image-post-thumb featured-thumbnail home_page_builder_thumbnial">
                                <div class="jl_img_container"> <span class="image_grid_header_absolute"
                                        style="background-image: url('{{ asset('assets_front/img/uploads/2016/12/felipe-sagn-1434616-unsplash-780x450.jpg') }}')"></span>
                                    <a href="#" class="link_grid_header_absolute"></a>
                                </div>
                            </div>
                            <div class="post-entry-content"> <span class="meta-category-small"><a
                        ...
                        <div class="blog_list_post_style">
                            <div class="image-post-thumb featured-thumbnail home_page_builder_thumbnial">
                                <div class="jl_img_container"> <span class="image_grid_header_absolute"
                                        style="background-image: url('{{ asset('assets_front/img/uploads/2016/12/daniel-korpai-1435296-unsplash-780x450.jpg') }}')"></span>
                                    <a href="#" class="link_grid_header_absolute"></a> <span
                                        class="jl_post_type_icon"><i class="la la-camera"></i></span>
                                </div>
                            </div>
                            <div class="post-entry-content"> <span class="meta-category-small"><a
                                        class="post-category-color-text" style="background:#36c942"
                                        href="#">Sports</a></span> <span
                                    class="post-meta meta-main-img auto_image_with_date"><span class="post-date"><i
                                            class="fa fa-clock-o"></i>Dec 24, 2016</span><span class="meta-comment"><a
                                            href="#"><i class="fa fa-comment"></i>0</a></span></span>
                                <h3 class="image-post-title"><a href="#">
                        ...
                        <div class="blog_list_post_style">
                            <div class="image-post-thumb featured-thumbnail home_page_builder_thumbnial">
                                <div class="jl_img_container"> <span class="image_grid_header_absolute"
                                        style="background-image: url('{{ asset('assets_front/img/uploads/2019/02/ashley-knedler-90856-unsplash-780x450.jpg') }}')"></span>
                                    <a href="#" class="link_grid_header_absolute"></a> <span
                        ...
                        <div class="blog_list_post_style">
                            <div class="image-post-thumb featured-thumbnail home_page_builder_thumbnial">
                                <div class="jl_img_container"> <span class="image_grid_header_absolute"
                                        style="background-image: url('{{ asset('assets_front/img/uploads/2019/03/jeshoots-com-523925-unsplash-780x450.jpg') }}')"></span>
                                    <a href="#" class="link_grid_header_absolute"></a> <span
                        ...
                        <div class="wrapper_category_image">
                            <div class="category_image_wrapper_main">
                                <div class="category_image_bg_image"
                                    style="background-image: url('{{ asset('assets_front/img/uploads/2019/02/annie-spratt-70918-unsplash-400x280.jpg') }}');">
                                ...
                                <div class="category_image_bg_image"
                                    style="background-image: url('{{ asset('assets_front/img/uploads/2019/02/soroush-karimi-253940-unsplash-400x280.jpg') }}');">
                                ...
                                <div class="category_image_bg_image"
                                    style="background-image: url('{{ asset('assets_front/img/uploads/2019/02/pexels-photo-1003816-400x280.jpg') }}');">
                                ...
                                <div class="category_image_bg_image"
                                    style="background-image: url('{{ asset('assets_front/img/uploads/2019/02/christopher-burns-617704-unsplash-400x280.jpg') }}');">
                                    <a class="category_image_link" id="category_color_5" href="#"><span
                                            class="jl_cm_overlay"><span class="jl_cm_name">Gaming</span><span
                                                class="jl_cm_count">10</span></span></a>
                                ...
                                <ul class="feature-post-list recent-post-widget">
                                    <li>
                                        <a href="#"
                                            ...
                                            <img width="120" height="120"
                                                src="{{ asset('assets_front/img/uploads/2019/02/sawyer-bengtson-1331688-unsplash-120x120.jpg') }}"
                                                class="attachment-disto_small_feature size-disto_small_feature wp-post-image"
                                                alt="" />
                                            <div class="background_over_image"></div>
                                        </a>
                                    ...
                                    <li>
                                        <a href="#"
                                            ...
                                            <img width="120" height="120"
                                                src="{{ asset('assets_front/img/uploads/2018/11/susan-yin-698530-unsplash-120x120.jpg') }}"
                                                class="attachment-disto_small_feature size-disto_small_feature wp-post-image"
                                                alt="" />
                                            <div class="background_over_image"></div>
                                        </a>
                                    ...
                                    <li>
                                        <a href="#"
                                            ...
                                            <img width="120" height="120"
                                                src="{{ asset('assets_front/img/uploads/2018/11/melissa-walker-horn-1058236-unsplash-120x120.jpg') }}"
                                                class="attachment-disto_small_feature size-disto_small_feature wp-post-image"
                                                alt="" />
                                            <div class="background_over_image"></div>
                                        </a>
                    ...
                    <div id="panel-4212-2-1-3"
                        ...
                        <div class="slider_widget_post jelly_loading_pro">
                            <div class="recent_post_large_widget"> <span class="image_grid_header_absolute"
                                    style="background-image: url('{{ asset('assets_front/img/uploads/2019/03/banter-snaps-1438384-unsplash-380x350.jpg') }}')"></span>
                                <a href="#" class="link_grid_header_absolute"
                                ...
                                <div class="wrap_box_style_main image-post-title">
                                    ...
                                    <span class="jl_post_meta"><span class="jl_author_img_w"> <img src="{{asset('assets_front/img/favicon.jpg')}}"
                            ...
                            <div class="recent_post_large_widget"> <span class="image_grid_header_absolute"
                                    style="background-image: url('{{ asset('assets_front/img/uploads/2016/12/bartosz-wanot-133401-unsplash-380x350.jpg') }}')"></span>
                                <a href="#" class="link_grid_header_absolute"
                                ...
                                <div class="image-post-thumb">
                                    <a href="#" class="link_image featured-thumbnail"
                                        ...
                                        <img width="400" height="280"
                                            src="{{ asset('assets_front/img/uploads/2019/03/toa-heftiba-686126-unsplash-400x280.jpg') }}"
                            ...
                            <div class="jl_grid_box_wrapper">
                                <div class="image-post-thumb">
                                    <a href="#" class="link_image featured-thumbnail"
                                        ...
                                        <img width="400" height="280"
                                            src="{{ asset('assets_front/img/uploads/2019/03/ben-blennerhassett-300784-unsplash-400x280.jpg') }}"
                                            class="attachment-disto_slider_grid_small size-disto_slider_grid_small wp-post-image"
                                            alt="" />
                                        <div class="background_over_image"></div>
                                    </a> <span class="meta-category-small"><a class="post-category-color-text"
                                            style="background:#36c942" href="#">Sports</a></span> <span
                                        class="jl_post_type_icon"><i class="la la-camera"></i></span>
                                </div>
                                <div class="post-entry-content">
                                    <h3 class="image-post-title"><a href="#">
                            ...
                            <div class="jl_grid_box_wrapper">
                                <div class="image-post-thumb">
                                    <a href="#" class="link_image featured-thumbnail"
                                        ...
                                        <img width="400" height="280"
                                            src="{{ asset('assets_front/img/uploads/2019/02/matthew-hamilton-202227-unsplash-400x280.jpg') }}"
                                            class="attachment-disto_slider_grid_small size-disto_slider_grid_small wp-post-image"
                                            alt="" />
                                        <div class="background_over_image"></div>
                                    </a> <span class="meta-category-small"><a class="post-category-color-text"
                            ...
                            <div class="jl_grid_box_wrapper">
                                <div class="image-post-thumb">
                                    <a href="#" class="link_image featured-thumbnail"
                                        ...
                                        <img width="400" height="280"
                                            src="{{ asset('assets_front/img/uploads/2019/02/angel-jimenez-168185-unsplash-1-400x280.jpg') }}"
                                            class="attachment-disto_slider_grid_small size-disto_slider_grid_small wp-post-image"
                                            alt="" />
                                        <div class="background_over_image"></div>
                                    </a> <span class="meta-category-small"><a class="post-category-color-text"
